 ...
 */
 module.exports = {
  ...
  //@param year 阳历年
  //@param between 天数
  lunarByBetween : function(year, between, fullLunar)  {
      ...
      if (fullLunar) return lunarArray
      if (leapMonth !== 0 && (lunarArray[1] - leapMonth > 0)) {
        return {year, month: t - 1, day: e}
      }
      return {year, month: t, day: e}
  },
  //中文月份
  ...
  //转换农历
  toLunar : function(year, month, day, fullLunar)  {
      const yearData = this.lunarInfo[year - this.MIN_YEAR];
      if (year == this.MIN_YEAR && month <= 2 && day <= 9) {
          return [1891, 1, 1, '辛卯', '兔', '正月', '初一'];
      }
      return this.lunarByBetween(year, this.betweenSolarDays(year, month, day, yearData[1], yearData[2]), fullLunar);
  },
  //转换公历
  //@param year  阴历-年
